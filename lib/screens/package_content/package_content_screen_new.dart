...
class _PackageContentScreenState extends State<PackageContentScreen> {
  ...
  String? _selectedFunction =
      'overview'; // 当前选中的功能按钮：'overview', 'delete', 'add'，默认为总览
  ...
  Widget _buildFunctionButtons() {
    return Padding(
      ...
      child: Row(
        children: [
          // 包裹总览按钮
          Expanded(child: _buildFunctionButton('包裹总览', '0', 'overview')),
          const SizedBox(width: 8),

          // 删除文件按钮
          Expanded(child: _buildFunctionButton('删除文件', '0', 'delete')),
          const SizedBox(width: 8),

          // 添加文件按钮
          Expanded(child: _buildFunctionButton('添加文件', '0', 'add')),
        ],
      ),
    );
  }
      ...
      children: [
        ...
        Row(
          children: [
            ...
            // 真我录按钮
            Expanded(child: _buildFilterButton('真我录', color: getFilterColor())),
            const SizedBox(width: 8),

            // 许愿按钮
            Expanded(child: _buildFilterButton('许愿', color: getFilterColor())),
          ],
        ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Icon(_getIconForFunction(), color: getTitleColor(), size: 20),
              const SizedBox(width: 8),
              Text(
                getDisplayTitle(),
                style: TextStyle(
