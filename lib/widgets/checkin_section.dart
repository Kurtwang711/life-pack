      ...
      child: Container(
        ...
        child: Column(
          children: [
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    // 祝福语按钮
                    BlessingButton(checkinManager: checkinManager),
                ...
                // 右侧时钟图标
                Icon(Icons.access_time, color: Colors.grey[800], size: 24),
              ],
            ),
            ...
            // 进度条
            ProgressBarWidget(checkinManager: checkinManager),
          ],
        ),
      ),
    );
