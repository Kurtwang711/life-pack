...
class PackageInfoCard extends StatelessWidget {
  ...
  const PackageInfoCard({super.key, required this.package, this.onTap});
  ...
  Widget build(BuildContext context) {
    try {
      return GestureDetector(
        onTap: onTap,
        child: Container(
          margin: const EdgeInsets.symmetric(horizontal: 4), // 左右4px边距
      ...
      return Container(
        ...
        child: Text(
          '包裹信息卡片渲染错误: ${package.packageNumber}',
